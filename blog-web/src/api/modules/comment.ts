...
export type CommentListResponse = Promise<
  AxiosResponse<{ code: number; message: string; data: CommentListVO }>
>
export type CommentResponse = Promise<
  AxiosResponse<{ code: number; message: string; data: CommentVO }>
>
...
export type MyCommentListResponse = Promise<
  AxiosResponse<{ code: number; message: string; data: MyCommentListVO }>
>
